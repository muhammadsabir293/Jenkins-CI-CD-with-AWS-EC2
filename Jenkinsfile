    ...
    stages {
        stage("Cloning the code from a Git repository") {
            ...
            steps {
                ...
                git url: "https://github.com/muhammadsabir293/Jenkins-CI-CD-with-AWS-EC2.git/", branch: "main"
        ...
        stage("Building and testing the Docker image") {
            ...
            steps {
                ...
                sh "docker build -t sabir799/my-node-app . "
        ...
        stage("Pushing to DockerHub") {
            ...
            steps {
                ...
                
                {
                    ...
                    sh "docker push sabir799/my-node-app"
